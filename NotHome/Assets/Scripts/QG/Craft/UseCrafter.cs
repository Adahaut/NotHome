...
public class UseCrafter : MonoBehaviour
{
    ...
    public void MoveButton(int direction)
    {
        ...
        {
            _listButton[i].transform.position += new Vector3(130 * Screen.width / 1920 * direction, 0, 0);
        }
        if (direction < 0)
        {
            _listButton[_indexMove].transform.position += new Vector3(130 * Screen.width / 1920 * _listButton.Count, 0, 0);
            _indexMove += 1;
        ...
        else
        {
            if (_indexMove != 0)
            {
                _listButton[_indexMove - 1].transform.position -= new Vector3(130 * Screen.width / 1920 * _listButton.Count, 0, 0);
                _indexMove -= 1;
                if (_indexMove < 0)
            ...
            {
                _listButton[_listButton.Count - 1].transform.position -= new Vector3(130 * Screen.width / 1920 * _listButton.Count, 0, 0);
                _indexMove = _listButton.Count - 1;
            }
        }
    }
